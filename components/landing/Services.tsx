...
export default function Services() {
  return (
    <section id="services" className="py-20 bg-gray-50 min-h-screen flex items-center">
          ...
          {services.map((service, index) => (
            <AnimatedSection key={service.title} delay={index * 120}>
              <div 
                ...
                className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-transform duration-300 hover:-translate-y-1"
              >
